    ...
    create or replace table `cloudprojects-506123`.`portvessel_dev_silver`.`int_vessel_state_intervals`
      
    partition by state_start_date
    cluster by port_id, mmsi, vessel_state
